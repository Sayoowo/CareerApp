...
All project documentation is in the `/docs` directory. See [Documentation Index](docs/README.md).

**Key Documents:**
- [Kanban Methodology](docs/01_Methodology/overview.md)
- [Stakeholder Communication Plan](docs/02_Communication/communication_plan.md)
- [Team Agreement](docs/03_Collaboration/team_agreement.md)
- [Project Schedule](docs/02_Communication/project_schedule.md)

**Live Tracking:**
- [GitHub Project Board](https://github.com/orgs/Mindful-Makers/projects/5/views/1)
...
Please refer to our [Team Agreement](docs/03_Collaboration/team_agreement.md) for contribution guidelines and workflow.
